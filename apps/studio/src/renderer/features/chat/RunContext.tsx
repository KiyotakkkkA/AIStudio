...
export default observer(function RunContext({ store }: { readonly store: ChatStore }) {
  ...
  return (
    <aside
      ...
      className={`flex w-73 shrink-0 flex-col gap-4 overflow-y-auto border-l border-main-700 bg-main-900 p-4 max-[1250px]:w-57.5 ${store.contextOpen ? "max-[1100px]:absolute max-[1100px]:inset-y-0 max-[1100px]:right-0 max-[1100px]:z-10 max-[1100px]:w-73" : "max-[1100px]:hidden"}`}
    >
