      ...
      {inFlight ? null : installed ? (
        <Button
          ...
          modalSetup={{
            ...
            content:
              item.kind === "runtime"
                ? "Распакованная сборка движка будет удалена с диска. Если на неё настроены хранилища, локальные эмбеддинги перестанут считаться, пока не установлен другой движок."
                : "Файл будет удалён с диска. Скачать его снова можно в любой момент.",
